...
namespace Millennium.Internal.OdinSerializer
{
    using Millennium.Internal.OdinSerializer.Utilities;
    using Millennium.Internal.OdinSerializer.Utilities.Unsafe;
    using System;
