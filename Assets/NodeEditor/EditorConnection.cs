...
{
    public EditorFlowConnectionPoint inPoint;
    public EditorFlowConnectionPoint outPoint;
    public Action<EditorConnection> OnRemoveConnection;

    public EditorConnection(EditorFlowConnectionPoint inPoint, EditorFlowConnectionPoint outPoint, Action<EditorConnection> OnRemoveConnection) {
